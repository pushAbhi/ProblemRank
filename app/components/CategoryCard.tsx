...
export function CategoryCard({ icon: Icon, label, count, tone, active }: CategoryCardProps) {
  return (
    <button
      className={`group flex min-w-[180px] items-center gap-3 rounded-2xl border bg-card p-3 text-left shadow-card transition hover:-translate-y-0.5 hover:border-brand/40 ${
